...
public class StudentManageFrame extends JInternalFrame {
	...
	public StudentManageFrame() {
		...
		label.setIcon(new ImageIcon(StudentManageFrame.class.getResource("/img/\u7528\u6237\u540D2.png")));
		...
		label_1.setIcon(new ImageIcon(StudentManageFrame.class.getResource("/img/\u5B66\u53F7.png")));
		...
		label_2.setIcon(new ImageIcon(StudentManageFrame.class.getResource("/img/\u7528\u6237\u540D2.png")));
		...
		label_3.setIcon(new ImageIcon(StudentManageFrame.class.getResource("/img/\u7BA1\u7406\u5458\u4FEE\u6539\u5BC6\u7801.png")));
		...
		submitEditButton.setIcon(new ImageIcon(StudentManageFrame.class.getResource("/img/\u786E\u8BA4.png")));
		submitEditButton.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 14));
		
		JButton deleteStudentButton = new JButton("\u5220\u9664\u5B66\u751F");
		deleteStudentButton.setIcon(new ImageIcon(StudentManageFrame.class.getResource("/img/\u5220\u9664 .png")));
